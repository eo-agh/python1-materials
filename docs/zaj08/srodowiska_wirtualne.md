...
!!! success "Dlaczego mamba + conda-lock na tych zajęciach?"
    ...
    - Ekosystem **conda-forge** oferuje gotowe pakiety geoinformatyczne (GDAL, PROJ, rasterio) bez konieczności kompilacji,
    - To sprawdzony zestaw w projektach data science i geoinformatycznych.
